 ...
 */
final class Version20240123080720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, address_id INT NOT NULL, type_logement_id INT NOT NULL, prix INT NOT NULL, nombre_couchage INT NOT NULL, INDEX IDX_F65593E5FB88E14F (utilisateur_id), INDEX IDX_F65593E5F5B7AF75 (address_id), INDEX IDX_F65593E513B22EC4 (type_logement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
